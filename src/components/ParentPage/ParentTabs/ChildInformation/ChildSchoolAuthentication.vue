  ...
  <el-card shadow="hover">
    ...
    <el-form label-width="auto">
      <el-form-item label="学校">
        <el-input disabled placeholder="您的孩子尚未绑定学校" v-model="student.school"/>
      </el-form-item>
      <el-form-item label="学号">
        <el-input disabled placeholder="您的孩子尚未绑定学号" v-model="student.id"/>
      </el-form-item>
